        ...
        var options = new SessionCreateOptions
        {
            ...
            LineItems = new List<SessionLineItemOptions>
            {
                new SessionLineItemOptions
                {
                    ...
                    {
                        UnitAmount = Convert.ToInt64(order.Price * 100),
                        Currency = "cny",
...
public class StripeCardPaymentGateway : IPaymentGateway
{
    ...
    public StripeCardPaymentGateway(IOptionsSnapshot<Dictionary<string, Dictionary<string, object>>> options, Order order)
    {
